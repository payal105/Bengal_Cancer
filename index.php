  ...
  <div class="container">
        ...
        <div class="hs_service">
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-8">
              <h4>Diabetes and Obesity Counseling</h4>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4" style="text-align:center;"> <svg version="1.1" id="Layer_13"
                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                width="80px" height="80px" viewBox="0 0 100 100" enable-background="new 0 0 100 100"
                xml:space="preserve">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="hs_service">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4" style="text-align:center;"> <svg version="1.1" id="Layer_1"
                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                width="60px" height="80px" viewBox="0 0 512 512" enable-background="new 0 0 512 512"
                xml:space="preserve">
                <path
                  d="M448,160c17.656,0,32,14.344,32,32v256c0,17.656-14.344,32-32,32H64c-17.641,0-32-14.344-32-32V192
	...
	c0-35.344-28.656-64-64-64H192c-35.344,0-64,28.656-64,64v32H160z M352,288h-64v-64h-64v64h-64v64h64v64h64v-64h64V288z" />
      ...
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="hs_service">
          <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-8">
              <h4>Surgical and medical Oncology</h4>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4" style="text-align:center;"> <svg version="1.1" id="Layer_2"
                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                width="60px" height="80px" viewBox="0 0 32 32" enable-background="new 0 0 32 32" xml:space="preserve">
                <g>
    ...
    <div class="row">
        ...
        <div class="hs_tab">
          ...
          <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="services1">
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6"> <img width="228" height="252" src="images/service/1.jpg"
                    alt="" /> </div>
            ...
            <div class="tab-pane fade" id="services3">
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12"> <img width="515" height="252" src="images/service/2.jpg"
                    alt="" />
                  <h4 class="hs_theme_color">Morbi id pulvinar enim. Vestibulum sed .</h4>
      ...
      <div class="col-lg-6 col-md-12 col-sm-12">
        ...
        <div class="hs_appointment_form_div"> <img src="images/bg/appointment_form.jpg" width="512" height="365"
            alt="" />
          ...
          <div id="up_coming_events_slider" class="owl-carousel owl-theme">
            <div class="up_coming_events_slider_item">
              ...
              <div class="hs_event_div">
                <div class="row">
                  <div class="col-lg-6 col-md-5 col-sm-6"> <img src="images/event/up_comming_event1.jpg" alt="" />
                  </div>
                  <div class="col-lg-6 col-md-7 col-sm-12">
            ...
            <div class="up_coming_events_slider_item">
              ...
              <div class="hs_event_div">
                <div class="row">
                  <div class="col-lg-6 col-md-5 col-sm-6"> <img src="images/event/up_comming_event2.jpg" alt="" />
                  </div>
                  <div class="col-lg-6 col-md-7 col-sm-12">
                    <h4>Pelln sque vitae dolor non.</h4>
                    <p>Cras sodaleut ligula, velit enim quis, neatis feugiat ante. Ut arcu nulla.Cras velit ligula,
            ...
            <div class="up_coming_events_slider_item">
              ...
              <div class="hs_event_div">
                <div class="row">
                  <div class="col-lg-6 col-md-5 col-sm-6"> <img src="images/event/up_comming_event3.jpg" alt="" />
                  </div>
                  <div class="col-lg-6 col-md-7 col-sm-12">
                    <h4>Pelln sque vitae dolor non.</h4>
                    <p>Cras sodaleut ligula, velit enim quis, neatis feugiat ante. Ut arcu nulla.Cras velit ligula,
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="our_partners">
          <div id="our_partners_slider" class="owl-carousel owl-theme">
            <div class="our_partners_slider_item"> <img src="images/partner/partner1.png" alt="" width="142"
                height="40" /> </div>
            <div class="our_partners_slider_item"> <img src="images/partner/partner2.png" alt="" width="142"
                height="40" /> </div>
            <div class="our_partners_slider_item"> <img src="images/partner/partner3.png" alt="" width="142"
                height="40" /> </div>
            <div class="our_partners_slider_item"> <img src="images/partner/partner4.png" alt="" width="142"
                height="40" /> </div>
            <div class="our_partners_slider_item"> <img src="images/partner/partner1.png" alt="" width="142"
                height="40" /> </div>
          </div>
            ...
            <div class="hs_footer_about_us">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-md-12 col-sm-12">
                  ...
                  <a href="index.html"><img src="images/logo.svg" alt="logo" width="180" height="41" /></a>
                </div>
