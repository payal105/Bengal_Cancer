            ...
            <ul class="hs_menu collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <li><a class="active" href="index.php">Home</a>
                <!-- <ul>
                  ...
                  <li><a href="index_babycare.html">home V2</a></li>
                  <li><a href="index_dentist.html">home V3</a></li>
                  ...
                  <li><a href="index_new.html">Home V7</a></li>
                  <li class="hc-home-new">
                    <a href="healthcare/index.html">home one page V8</a>
                  </li>
                </ul> -->
              </li>
              ...
              <li><a href="profile.php">our doctors</a></li>
